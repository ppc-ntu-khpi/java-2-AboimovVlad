[![Open in Codespaces](https://classroom.github.com/assets/launch-codespace-2972f46106e565e64193e422d61a12cf1da4916b45550586e14ef0a7c637dd04.svg)](https://classroom.github.com/open-in-codespaces?assignment_repo_id=24084820)
...
## Обране завдання
### Завдання 2: Перетворення шестизначного числа у двійкову, восьмеричну та шістнадцятиричну систему

Для цього завдання реалізовано метод `Calculate` класу `Exercise`, який приймає одне шестизначне десяткове число і повертає рядок із трьома записами:

- двійкове представлення
- восьмеричне представлення
- шістнадцятиричне представлення

Кожне значення розділене комою.

#### Приклад

```text
Вхід: 123456
Вихід: 11110001001000000, 361100, 1E240
```

#### Як це працює

- `Integer.toBinaryString(number)` повертає двійкову форму
- `Integer.toOctalString(number)` повертає восьмеричну форму
- `Integer.toHexString(number).toUpperCase()` повертає шістнадцятиричну форму у верхньому регістрі

> У цьому проєкті приклад реалізації показує перетворення числа `123456` у три основні системи числення.
